...
export const INITIAL_USERS: User[] = [
  {
    ...
    phone: '081234567890',
    status: 'Aktif',
    ulpName: 'UL BUKITTINGGI',
    unitId: 'UL2',
    avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'usr-2',
    nip: '199002102015031002',
    userName: 'adminbkt',
    password: 'bkt123',
    name: 'Rahmat Hidayat (Admin BKT)',
    email: 'admin.bkt@pln.co.id',
    role: 'Admin',
    phone: '081234567891',
    status: 'Aktif',
    ulpName: 'ULP BUKITTINGGI KOTA',
    unitId: 'UL2',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'usr-3',
    nip: '199205122016041003',
    userName: 'adminpdg',
    password: 'pdg123',
    name: 'Ahmad Fauzi (Admin PDG)',
    email: 'admin.pdg@pln.co.id',
    role: 'Admin',
    phone: '081234567892',
    status: 'Aktif',
    ulpName: 'ULP KURANJI',
  ...
  {
    id: 'usr-4',
    nip: '199408202018021004',
    userName: 'admink3',
    password: 'k3123',
    name: 'Siti Rahmah (Admin K3 & Teknik)',
    email: 'k3.bkt@pln.co.id',
    role: 'Adm',
    phone: '081234567893',
    status: 'Aktif',
    ulpName: 'UL BUKITTINGGI',
  ...
  },
  {
    ...
    userName: 'petugasrow',
    password: 'row123',
    name: 'BUDI SANTOSO (Tim Alpha)',
    email: 'budi.row@pln.co.id',
    role: 'User',
    phone: '081234567891',
    status: 'Aktif',
    ulpName: 'ULP BUKITTINGGI KOTA',
  ...
  },
  {
    ...
    password: 'row123',
    name: 'DEDI KURNIAWAN (Tim Beta)',
    email: 'dedi.row@pln.co.id',
    role: 'User',
    phone: '081234567894',
    status: 'Aktif',
    ulpName: 'ULP BUKITTINGGI KOTA',
  ...
  },
  {
    ...
    password: 'row123',
    name: 'FERDIANSYAH (Tim Kuranji)',
    email: 'ferdi.row@pln.co.id',
    role: 'User',
    phone: '081234567897',
    status: 'Aktif',
    ulpName: 'ULP KURANJI',
    reguName: 'REGU KURANJI 01',
    unitId: 'UL1',
  }
];
