              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-3.5 py-2.5 rounded-xl font-bold text-xs sm:text-sm transition-all duration-200 group ${
                    isActive
                      ? 'bg-gradient-to-r from-teal-700 via-teal-600 to-teal-600 text-white font-bold shadow-md shadow-teal-600/30'
                      : 'text-slate-600 dark:text-slate-300 hover:bg-teal-50/80 dark:hover:bg-slate-800/80 hover:text-teal-700 dark:hover:text-teal-300'
                  }`}
                >
                  <Icon
